...
// translation vission
// src/component/about/ministry.jsx
// src/component/about/ministry.jsx
      ...
      <main className="[--brand:#2FA8E1] pt-[117px] [--brand-dark:#0A7FB8] top-[100px] bg-white text-slate-900 ">
        ...
        <section className="relative py-16 bg-white">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center px-6">
            ...
            {/* Right: About Us Content */}
            <div>
              <h2 className="text-4xl font-extrabold text-[var(--brand)] mb-4">{t("about.heading")}</h2>
              <p className="text-lg font-semibold text-[var(--brand)] mb-3">
                {t("about.lead")}
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid gap-8 md:grid-cols-2">
              ...
              <article className="rounded-2xl bg-white shadow-sm border border-[#2FA8E1]/30 p-8">
                ...
                <h3 className="mt-2 text-3xl font-extrabold text-[#2FA8E1]">{t("vision.title")}</h3>
                <p className="mt-4 text-slate-700 leading-relaxed">
                  {t("vision.text")}
                </p>
              </article>
              ...
              <article className="rounded-2xl bg-white shadow-sm border border-[#2FA8E1]/30 p-8">
                ...
                <h3 className="mt-2 text-3xl font-extrabold text-[#2FA8E1]">{t("mission.title")}</h3>
                <p className="mt-4 text-slate-700 leading-relaxed">
                  {t("mission.text")}
                </p>
              </article>
        ...
        <section className="py-16 bg-[var(--brand)]/5">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-extrabold text-center text-[var(--brand)]">{t("departments.title")}</h2>
            <div className="h-1 w-24 bg-[var(--brand)] mx-auto mt-2 rounded"></div>

            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              <article className="group rounded-2xl bg-white p-6 border border-[var(--brand)]/30 shadow-sm hover:shadow-xl transition hover:-translate-y-1">
                <h3 className="text-xl font-semibold text-[var(--brand)] group-hover:text-[var(--brand-dark)]">
                  {t("departments.cards.0.title")}
                </h3>
                <p className="mt-3 text-sm leading-relaxed">{t("departments.cards.0.text")}</p>
                <a className="mt-5 inline-flex items-center gap-2 text-sm font-medium text-white bg-[var(--brand)] hover:bg-[var(--brand-dark)] px-4 py-2 rounded-lg transition" href="#">
                  {t("departments.cards.0.cta")}
                </a>
              </article>

              <article className="group rounded-2xl bg-white p-6 border border-[var(--brand)]/30 shadow-sm hover:shadow-xl transition hover:-translate-y-1">
                <h3 className="text-xl font-semibold text-[var(--brand)] group-hover:text-[var(--brand-dark)]">
                  {t("departments.cards.1.title")}
                </h3>
                <p className="mt-3 text-sm leading-relaxed">{t("departments.cards.1.text")}</p>
                <a className="mt-5 inline-flex items-center gap-2 text-sm font-medium text-white bg-[var(--brand)] hover:bg-[var(--brand-dark)] px-4 py-2 rounded-lg transition" href="#">
                  {t("departments.cards.1.cta")}
                </a>
              </article>

              <article className="group rounded-2xl bg-white p-6 border border-[var(--brand)]/30 shadow-sm hover:shadow-xl transition hover:-translate-y-1">
                <h3 className="text-xl font-semibold text-[var(--brand)] group-hover:text-[var(--brand-dark)]">
                  {t("departments.cards.2.title")}
                </h3>
                <p className="mt-3 text-sm leading-relaxed">{t("departments.cards.2.text")}</p>
                <a className="mt-5 inline-flex items-center gap-2 text-sm font-medium text-white bg-[var(--brand)] hover:bg-[var(--brand-dark)] px-4 py-2 rounded-lg transition" href="#">
                  {t("departments.cards.2.cta")}
                </a>
              </article>

              <article className="group rounded-2xl bg-white p-6 border border-[var(--brand)]/30 shadow-sm hover:shadow-xl transition hover:-translate-y-1">
                <h3 className="text-xl font-semibold text-[var(--brand)] group-hover:text-[var(--brand-dark)]">
                  {t("departments.cards.3.title")}
                </h3>
                <p className="mt-3 text-sm leading-relaxed">{t("departments.cards.3.text")}</p>
                <a className="mt-5 inline-flex items-center gap-2 text-sm font-medium text-white bg-[var(--brand)] hover:bg-[var(--brand-dark)] px-4 py-2 rounded-lg transition" href="#">
                  {t("departments.cards.3.cta")}
                </a>
              </article>
            </div>
          </div>
        ...
        <section id="achievements" className="py-14 lg:py-20">
          <div className="max-w-6xl mx-auto px-4 text-black">
            <div className="text-center mb-10">
              <h2 className="section-title mt-2 text-2xl font-bold">{t("achievements.title")}</h2>
            </div>

            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="rounded-2xl p-6 bg-[#2FA8E1] text-white shadow-sm">
                <div className="font-bold">{t("achievements.stats.0.value")}</div>
                <p className="mt-1">{t("achievements.stats.0.text")}</p>
              </div>
              <div className="rounded-2xl p-6 bg-[#2FA8E1] text-white shadow-sm">
                <div className="font-bold">{t("achievements.stats.1.value")}</div>
                <p className="mt-1">{t("achievements.stats.1.text")}</p>
              </div>
              <div className="rounded-2xl p-6 bg-[#2FA8E1] text-white shadow-sm">
                <div className="font-bold">{t("achievements.stats.2.value")}</div>
                <p className="mt-1">{t("achievements.stats.2.text")}</p>
              </div>
              <div className="rounded-2xl p-6 bg-[#2FA8E1] text-white shadow-sm">
                <div className="font-bold">{t("achievements.stats.3.value")}</div>
                <p className="mt-1">{t("achievements.stats.3.text")}</p>
              </div>
              <div className="rounded-2xl p-6 bg-[#2FA8E1] text-white shadow-sm">
                <div className="font-bold">{t("achievements.stats.4.value")}</div>
                <p className="mt-1">{t("achievements.stats.4.text")}</p>
              </div>
              <div className="rounded-2xl p-6 bg-[#2FA8E1] text-white shadow-sm">
                <div className="font-bold">{t("achievements.stats.5.value")}</div>
                <p className="mt-1">{t("achievements.stats.5.text")}</p>
              </div>
              <div className="rounded-2xl p-6 bg-[#2FA8E1] text-white shadow-sm">
                <div className="font-bold">{t("achievements.stats.6.value")}</div>
                <p className="mt-1">{t("achievements.stats.6.text")}</p>
              </div>
              <div className="rounded-2xl p-6 bg-[#2FA8E1] text-white shadow-sm">
                <div className="font-bold">{t("achievements.stats.7.value")}</div>
                <p className="mt-1">{t("achievements.stats.7.text")}</p>
              </div>
              <div className="rounded-2xl p-6 bg-[#2FA8E1] text-white shadow-sm">
                <div className="font-bold">{t("achievements.stats.8.value")}</div>
                <p className="mt-1">{t("achievements.stats.8.text")}</p>
              </div>
              <div className="rounded-2xl p-6 bg-[#2FA8E1] text-white shadow-sm">
                <div className="font-bold">{t("achievements.stats.9.value")}</div>
                <p className="mt-1">{t("achievements.stats.9.text")}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="services" className="py-14">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-10">
              <h2 className="section-title mt-2 text-2xl font-bold">{t("services.title")}</h2>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="rounded-2xl overflow-hidden  border shadow-md border-slate-800  shadow-slate-900">
                <img className="h-40  w-80 object-cover" src="data:image/png;base64," alt="" />
                <div className="p-5">
                  <h4 className="font-bold">{t("services.cards.0.title")}</h4>
                  <p className="text-slate-600 mt-1">{t("services.cards.0.text")}</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl overflow-hidden  border shadow-md border-slate-800  shadow-slate-900">
                <img className="h-40 w-full object-cover" src="data:image/png;base64," alt="" />
                <div className="p-5">
                  <h4 className="font-bold">{t("services.cards.1.title")}</h4>
                  <p className="text-slate-600 mt-1">{t("services.cards.1.text")}</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl overflow-hidden  border shadow-md border-slate-800  shadow-slate-900">
                <img className="h-40 w-full object-cover" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSg2YGYgkKrBfyct-Jsq6eKjIX6zNqBEwgFoC8JQgaY2bVCiO4&s" alt="" />
                <div className="p-5">
                  <h4 className="font-bold">{t("services.cards.2.title")}</h4>
                  <p className="text-slate-600 mt-1">{t("services.cards.2.text")}</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl overflow-hidden border shadow-md border-slate-800  shadow-slate-900">
                <img className="h-40 w-full object-cover" src={service1} alt="" />
                <div className="p-5">
                  <h4 className="font-bold">{t("services.cards.3.title")}</h4>
                  <p className="text-slate-600 mt-1">{t("services.cards.3.text")}</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl overflow-hidden  border shadow-md border-slate-800  shadow-slate-900">
                <img className="h-40 w-full object-cover" src={service2} alt="" />
                <div className="p-5">
                  <h4 className="font-bold">{t("services.cards.4.title")}</h4>
                  <p className="text-slate-600 mt-1">{t("services.cards.4.text")}</p>
                </div>
              </div>

              <div className="rounded-2xl overflow-hidden shadow-md border border-slate-800  shadow-slate-900">
                <img className="h-40 w-full object-cover" src={service3} alt="" />
                <div className="p-5">
                  <h4 className="font-bold">{t("services.cards.5.title")}</h4>
                  <p className="text-slate-600 mt-1">{t("services.cards.5.text")}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-3xl md:text-4xl font-extrabold text-center text-[var(--brand)]">{t("officials.title")}</h2>
            <div className="h-1 w-24 bg-[var(--brand)] mx-auto mt-2 rounded"></div>

            <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {/* Official card */}
              <article className="rounded-2xl border border-[var(--brand)]/30 bg-white shadow-sm overflow-hidden">
                <img src={min1} alt={t("officials.minister.alt")} className="w-full aspect-[4/3] object-cover" />
                <div className="p-5">
                  <h3 className="text-[var(--brand)] font-semibold underline decoration-[var(--brand)]/30">
                    {t("officials.minister.name")}
                  </h3>
                  <p className="text-sm mt-1">{t("officials.minister.title")}</p>
                  <p className="text-xs text-slate-600 mt-2">
                    {t("officials.email")}{" "}
                    <a href="mailto:minister.moewr@jubalandstate.so" className="text-[var(--brand)] hover:text-[var(--brand-dark)]">
                      minister.moewr@jubalandstate.so
                    </a>
                  </p>
                  <a href="#" className="mt-4 inline-block text-xs px-3 py-1 rounded bg-[var(--brand)] text-white hover:bg-[var(--brand-dark)]">
                    Facebook
                  </a>
                </div>
              </article>
              ...
              <article className="rounded-2xl border border-[var(--brand)]/30 bg-white shadow-sm overflow-hidden">
                <img src={min2} alt={t("officials.deputy.alt")} className="w-full aspect-[4/3] object-cover" />
                <div className="p-5">
                  <h3 className="text-[var(--brand)] font-semibold underline decoration-[var(--brand)]/30">
                    {t("officials.deputy.name")}
                  </h3>
                  <p className="text-sm mt-1">{t("officials.deputy.title")}</p>
                  <p className="text-xs text-slate-600 mt-2">
                    {t("officials.email")}{" "}
                    <a href="mailto:deputyminister-moemw@jubalandstate.so" className="text-[var(--brand)] hover:text-[var(--brand-dark)]">
                      deputyminister-moemw@jubalandstate.so
                    </a>
                  </p>
                  <a href="#" className="mt-4 inline-block text-xs px-3 py-1 rounded bg-[var(--brand)] text-white hover:bg-[var(--brand-dark)]">
              ...
              <article className="rounded-2xl border border-[var(--brand)]/30 bg-white shadow-sm overflow-hidden">
                <img src={min3} alt={t("officials.dg.alt")} className="w-full aspect-[4/3] object-cover" />
                <div className="p-5">
                  <h3 className="text-[var(--brand)] font-semibold underline decoration-[var(--brand)]/30">
                    {t("officials.dg.name")}
                  </h3>
                  <p className="text-sm mt-1">{t("officials.dg.title")}</p>
                  <p className="text-xs text-slate-600 mt-2">
                    {t("officials.email")}{" "}
                    <a href="mailto:dg-moewr@jubalandstate.so" className="text-[var(--brand)] hover:text-[var(--brand-dark)]">
                      dg-moewr@jubalandstate.so
                    </a>
                  </p>
                  <a href="#" className="mt-4 inline-block text-xs px-3 py-1 rounded bg-[var(--brand)] text-white hover:bg-[var(--brand-dark)]">
