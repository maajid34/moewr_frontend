...
export default function Minister() {
  const { t } = useTranslation("minister");
    ...
    <div className="[--navy:#002B5C] pt-[117px] [--blue:#007BFF] [--gold:#FFD43B]">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-10 lg:gap-14 md:grid-cols-2 items-start">
          ...
          {/* RIGHT: biography */}
          <article className="bg-white/80 backdrop-blur rounded-2xl border border-[var(--blue)]/20 shadow-sm p-6 md:p-8">
            <h2 className="text-3xl font-extrabold text-[var(--navy)]">{t("minister.bio_heading")}</h2>
            <div className="mt-2 h-1 w-24 bg-[var(--gold)] rounded"></div>

            <div className="mt-5 space-y-4 leading-relaxed text-slate-700">
              <p>{t("minister.bio_p1")}</p>
              <p>{t("minister.bio_p2")}</p>
            </div>
          </article>
        </div>
      </section>
      ...
      <section className="relative">
        ...
        <div className="grid lg:grid-cols-2">
          ...
          <div className="bg-gradient-to-br from-[var(--navy)] to-[#063a7a] text-white">
            <div className="max-w-3xl mx-auto px-6 py-10 md:py-14">
              <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight">
                {t("minister.msg_heading")}
              </h2>
              <div className="mt-3 h-1 w-24 bg-[var(--gold)] rounded"></div>

              <div className="mt-8 space-y-5 leading-relaxed text-white/90">
                <p>{t("minister.msg_p1")}</p>
                <p>{t("minister.msg_p2")}</p>
                <p>{t("minister.msg_p3")}</p>
                <p>{t("minister.msg_p4")}</p>
                <p>{t("minister.msg_p5")}</p>
              </div>

              {/* signature */}
              <div className="mt-10">
                <p className="font-semibold">{t("minister.sign_1")}</p>
                <p className="mt-4 font-semibold">{t("minister.sign_2")}</p>
                <p className="text-white/80">{t("minister.sign_3")}</p>
                <p className="text-white/80">{t("minister.sign_4")}</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <div className="grid lg:grid-cols-2">
    ...
    <div className="bg-slate-50">
      <div className="max-w-3xl mx-auto px-6 py-10 md:py-14">
        ...
        <div className="mt-6 space-y-3 text-slate-700">
          <p>
            <span className="font-semibold text-[var(--ink)]">{t("deputy.label_expertise")}</span>{" "}
            {t("deputy.expertise_text")}
          </p>
          <p>
            <span className="font-semibold text-[var(--ink)]">{t("deputy.label_experience")}</span>{" "}
            {t("deputy.experience_years")}
          </p>
          <p>
            <span className="font-semibold text-[var(--ink)]">{t("deputy.label_email")}</span>{" "}
            <a
              href="mailto:deputyminister-momew@jubalandstate.so"
              className="text-[var(--brand-dark)] underline hover:text-[var(--brand)]"
            >
          ...
          <p>
            <span className="font-semibold text-[var(--ink)]">{t("deputy.label_tel")}</span> (+252) 612 536 316
          </p>
        </div>
  ...
  <div className="grid lg:grid-cols-2">
    ...
    <div className="bg-slate-50">
      <div className="max-w-3xl mx-auto px-6 py-10 md:py-14">
        ...
        <div className="mt-6 space-y-3 text-slate-700">
          <p>
            <span className="font-semibold text-[var(--ink)]">{t("director.label_expertise")}</span>{" "}
            {t("director.expertise_text")}
          </p>
          <p>
            <span className="font-semibold text-[var(--ink)]">{t("director.label_email")}</span>{" "}
            <a
              href="mailto:dg-moewr@jubalandstate.so"
              className="text-[var(--brand-dark)] underline hover:text-[var(--brand)]"
            >
            ...
            <span className="block md:inline md:ml-2">
              <span className="font-semibold text-[var(--ink)]">{t("director.label_phone")}</span> (+252) 618 549 958 / +252
              61 995 0037
            </span>
          </p>
        </div>
