...
// ==== API CONFIG ====
// If your Express router is mounted under /api, switch LIST_URL to `${API_BASE}/api/ReadAssess/DocumentFile`
...
function fileUrlOf(doc = {}) {
  if (doc.fileUrl) return doc.fileUrl; // prefer explicit url from backend
...
export default function PlanningPolicy() {
  ...
  const [docs, setDocs] = useState([]);        // always array
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        console.error("Assessments fetch error:", {
          message: e?.message,
          code: e?.code,
        ...
        if (alive) setErr("Failed to load assessments.");
      } finally {
  ...
  // Show only items that look like studies/assessments (optional, keep it so your Studies section stays clean)
  const studies = useMemo(() => {
    const list = Array.isArray(docs) ? docs : [];
    return list.filter((d) => {
      const c = String(d.category || "").toLowerCase();
      const t = String(d.title || "").toLowerCase();
      const ds = String(d.description || "").toLowerCase();
      return (
        c.includes("assessment") || c.includes("study") ||
        t.includes("assessment") || t.includes("study") ||
        ds.includes("assessment") || ds.includes("study")
      );
    });
  }, [docs]);
            ...
            <div className="px-6 sm:px-8 lg:px-12 py-10 lg:py-16 flex items-center">
              <div>
                ...
                <p className="text-xl font-semibold">
                  Welcome to the Department of Planning & Policy for the Ministry of Energy & Water Resources of Jubaland.
                </p>
        ...
        <section id="activities" className="py-14 sm:py-16 bg-[var(--brand)]/5">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <div className="mt-8 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition">
                <div className="flex items-center gap-3">
                  <span className="w-8 h-8 rounded-full bg-[var(--brand)] ring-2 ring-[var(--brand)]/30 flex items-center justify-center text-white text-sm font-bold">1</span>
                  <p className="font-semibold text-slate-900">Conducting research and analysis to inform policy development.</p>
                </div>
              </div>
              <div className="bg-white rounded-xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition">
                <div className="flex items-center gap-3">
                  <span className="w-8 h-8 rounded-full bg-[var(--brand)] ring-2 ring-[var(--brand)]/30 flex items-center justify-center text-white text-sm font-bold">2</span>
                  <p className="font-semibold text-slate-900">Drafting and reviewing policies and regulations related to energy and water management.</p>
                </div>
              </div>
              <div className="bg-white rounded-xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition">
                <div className="flex items-center gap-3">
                  <span className="w-8 h-8 rounded-full bg-[var(--brand)] ring-2 ring-[var(--brand)]/30 flex items-center justify-center text-white text-sm font-bold">3</span>
                  <p className="font-semibold text-slate-900">Collaborating with other departments and stakeholders to ensure integrated planning and policy coherence.</p>
                </div>
              </div>
              <div className="bg-white rounded-xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition">
                <div className="flex items-center gap-3">
                  <span className="w-8 h-8 rounded-full bg-[var(--brand)] ring-2 ring-[var(--brand)]/30 flex items-center justify-center text-white text-sm font-bold">4</span>
                  <p className="font-semibold text-slate-900">Organizing workshops, seminars, and training sessions for capacity building.</p>
                </div>
              </div>
              <div className="bg-white rounded-xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition">
                <div className="flex items-center gap-3">
                  <span className="w-8 h-8 rounded-full bg-[var(--brand)] ring-2 ring-[var(--brand)]/30 flex items-center justify-center text-white text-sm font-bold">5</span>
                  <p className="font-semibold text-slate-900">Monitoring and evaluating the effectiveness of existing policies and recommending adjustments as needed.</p>
                </div>
              </div>
              <div className="bg-white rounded-xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition">
                <div className="flex items-center gap-3">
                  <span className="w-8 h-8 rounded-full bg-[var(--brand)] ring-2 ring-[var(--brand)]/30 flex items-center justify-center text-white text-sm font-bold">6</span>
                  <p className="font-semibold text-slate-900">Preparing annual and long-term strategic plans for the Ministry.</p>
                </div>
              </div>
            </div>
          </div>
