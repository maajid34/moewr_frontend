...
export default function Water() {
  ...
  return (
    <>
      <div className="[--brand:#2FA8E1]  [--brand-dark:#0A7FB8] [--ink:#002B5C]">
          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="bg-slate-50">
              <div className="max-w-3xl mx-auto px-6 py-10 md:py-16">
                ...
                <h2 className='text-2xl mx-auto px-6 py-4 md:py-8'>{t("hero.overview")}</h2>
                <div className="mt-4 space-y-4 leading-relaxed text-slate-700">
                  <p>{t("hero.p1")}</p>
                </div>
              </div>
        ...
        <section id="vmo" className="max-w-7xl mx-auto px-4 py-16 lg:py-20">
          <div className="grid gap-10 lg:grid-cols-1 m-10">
            <div className="bg-white border rounded-2xl p-8 shadow-md box-shadow-slate-800 border-[var(--brand-dark)]">
              <div className="text-5xl">👁️</div>
              <h3 className="mt-3 text-2xl font-bold">{t("vision.title")}</h3>
              <p className="mt-2 text-slate-700 text-sm">
                {t("vision.text")}
              </p>
            </div>
        ...
        <section className="py-12 md:py-16 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <header className="text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-extrabold text-[var(--ink)]">{t("services.title")}</h2>
              <div className="mx-auto mt-3 h-1 w-24 bg-[var(--brand)] rounded"></div>
            </header>
            ...
            <div className="grid gap-10 md:grid-cols-2 xl:grid-cols-3">
              {/* 25,000 People */}
              <div className="text-center">
                <svg className="w-20 h-20 mx-auto text-[var(--brand-dark)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <path d="M6 19h12a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-3l-.6-1.2A2 2 0 0 0 12.6 4H9.4a2 2 0 0 0-1.8 1.2L7 6H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2Z" />
                  <path d="M9 13h6M9 10h6M9 16h3" />
                </svg>
                <h3 className="mt-4 text-xl font-bold text-[var(--ink)]">{t("services.cards.people.title")}</h3>
                <p className="mt-2 text-slate-600">{t("services.cards.people.text")}</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="mt-4 text-xl font-bold text-[var(--ink)]">{t("services.cards.boreholes.title")}</h3>
                <p className="mt-2 text-slate-600">{t("services.cards.boreholes.text")}</p>
              </div>

              {/* 251 Shallow Wells */}
              <div className="text-center">
                <svg className="w-20 h-20 mx-auto text-[var(--brand-dark)]" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                  <circle cx="12" cy="12" r="10" />
                  <path d="M8 12h8M12 8v8" />
                </svg>
                <h3 className="mt-4 text-xl font-bold text-[var(--ink)]">{t("services.cards.shallowWells.title")}</h3>
                <p className="mt-2 text-slate-600">{t("services.cards.shallowWells.text")}</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="mt-4 text-xl font-bold text-[var(--ink)]">{t("services.cards.kiosks.title")}</h3>
                <p className="mt-2 text-slate-600">{t("services.cards.kiosks.text")}</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="mt-4 text-xl font-bold text-[var(--ink)]">{t("services.cards.waterBan.title")}</h3>
                <p className="mt-2 text-slate-600">{t("services.cards.waterBan.text")}</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="mt-4 text-xl font-bold text-[var(--ink)]">{t("services.cards.barkad.title")}</h3>
                <p className="mt-2 text-slate-600">{t("services.cards.barkad.text")}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <header className="text-center mb-10">
              <h2 className="text-3xl md:text-4xl font-extrabold text-[var(--ink)]">{t("values.title")}</h2>
              <div className="mx-auto mt-3 h-1 w-24 bg-[var(--brand)] rounded"></div>
            </header>

            <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
              <div className=' border border-black box-shadow-black p-5'>
                <h3 className="text-xl font-bold text-[var(--brand-dark)]">{t("values.sustainability.title")}</h3>
                <p className="mt-2 text-slate-700">{t("values.sustainability.text")}</p>
              </div>

              <div className=' border border-black box-shadow-black p-5'>
                <h3 className="text-xl font-bold text-[var(--brand-dark)]">{t("values.community.title")}</h3>
                <p className="mt-2 text-slate-700">{t("values.community.text")}</p>
              </div>

              <div className=' border border-black box-shadow-black p-5'>
                <h3 className="text-xl font-bold text-[var(--brand-dark)]">{t("values.innovation.title")}</h3>
                <p className="mt-2 text-slate-700">{t("values.innovation.text")}</p>
              </div>

              <div className=' border border-black box-shadow-black p-5'>
                <h3 className="text-xl font-bold text-[var(--brand-dark)]">{t("values.transparency.title")}</h3>
                <p className="mt-2 text-slate-700">{t("values.transparency.text")}</p>
              </div>

              <div className=' border border-black box-shadow-black p-5'>
                <h3 className="text-xl font-bold text-[var(--brand-dark)]">{t("values.collaboration.title")}</h3>
                <p className="mt-2 text-slate-700">{t("values.collaboration.text")}</p>
              </div>
            </div>
          </div>
        </section>
  ...
  <div className="max-w-7xl mx-auto px-4 py-16 lg:py-20">
    <h2 className="text-3xl font-bold tracking-tight" data-aos="fade-up">
      {t("water:projects.waterProjects")}
    </h2>
