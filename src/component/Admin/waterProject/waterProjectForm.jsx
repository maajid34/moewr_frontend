...
//   const handleCreateProWater = async (e) => {
//     e.preventDefault();
...
//     // NEW: append multiple photos (backend field name "photos")
//     for (const file of projectPhotos) {
//       formData.append("photos", file);
//       // If your backend expects "photos[]", use:
//       // formData.append("photos[]", file);
//     }
...
//               {/* Objective Image */}
//               <div className="rounded-2xl border bg-white shadow-sm p-5">
//                 <h3 className="font-semibold text-[var(--ink)]">Objective Image</h3>
//                 <div className="mt-4 rounded-xl border border-dashed p-6 text-center">
//                   <div className="mx-auto w-12 h-12 rounded-xl bg-[var(--brand)]/10 grid place-items-center">
//                     <svg viewBox="0 0 24 24" className="w-6 h-6 text-[var(--brand)]"><path fill="currentColor" d="M6 2h9l5 5v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2Zm8 1.5V8h5.5L14 3.5Z"/></svg>
//                   </div>
...
//                 <div className="mt-4 rounded-xl border border-dashed p-6 text-center">
//                   <div className="mx-auto w-12 h-12 rounded-xl bg-[var(--brand)]/10 grid place-items-center">
//                     <svg viewBox="0 0 24 24" className="w-6 h-6 text-[var(--brand)]"><path fill="currentColor" d="M19 3H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2Zm-1 12-3.5-4.5-2.5 3L9 11l-4 4h13Z"/></svg>
//                   </div>
...
//                 <input
//                   value={componentOne}
//                   onChange={(t) => setComponentOne(t.target.value)}
//                   type="text"
//                   className="w-full rounded-lg border px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--brand)]"
//                 />
//                 <input
//                   value={componentTwo}
//                   onChange={(t) => setComponentTwo(t.target.value)}
//                   type="text"
//                   className="w-full rounded-lg border px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--brand)]"
//                 />
//                 <input
//                   value={componentThree}
//                   onChange={(t) => setComponentThree(t.target.value)}
//                   type="text"
//                   className="w-full rounded-lg border px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--brand)]"
//                 />
//                 <input
//                   value={componentFour}
//                   onChange={(t) => setComponentFour(t.target.value)}
//                   type="text"
//                   className="w-full rounded-lg border px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--brand)]"
//                 />
//               </div>
...
export default function WaterProjectFormUI() {
  ...
  return (
    <div className="absolute left-[300px] top-[100px] min-h-screen w-[calc(100%-300px)] bg-slate-50 text-slate-800">
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        <form className="space-y-8" method="post" encType="multipart/form-data" onSubmit={handleSubmit}>
          {/* ===== Basics ===== */}
          <section className="rounded-2xl border bg-white shadow-sm p-5">
            <h2 className="text-xl font-bold">Water project Form</h2>
          ...
          <section className="grid lg:grid-cols-2 gap-6">
            <div className="rounded-2xl border bg-white shadow-sm p-5">
              ...
              <input name="coverImage" type="file" accept="image/*" required className="mt-3" />
            </div>
            ...
            <div className="rounded-2xl border bg-white shadow-sm p-5">
              ...
              <input name="objectiveImage" type="file" accept="image/*" className="mt-3" />
            </div>
          ...
          <section className="rounded-2xl border bg-white shadow-sm p-5">
            ...
            <textarea name="objective" rows={4} required className="mt-3 w-full rounded-lg border px-3 py-2.5 text-sm" />
          </section>
          ...
          <section className="rounded-2xl border bg-white shadow-sm p-5">
            ...
            <div className="grid md:grid-cols-2 gap-5 mt-4">
              <input name="componentOne" type="text" className="w-full rounded-lg border px-3 py-2.5 text-sm" />
              <input name="componentTwo" type="text" className="w-full rounded-lg border px-3 py-2.5 text-sm" />
              <input name="componentThree" type="text" className="w-full rounded-lg border px-3 py-2.5 text-sm" />
              <input name="componentFour" type="text" className="w-full rounded-lg border px-3 py-2.5 text-sm" />
            </div>
          </section>
          ...
          <input
            name="StackeholderDesc"
            type="text"
            placeholder="Stakeholders section description"
          ...
          <section className="grid lg:grid-cols-2 gap-6">
            {/* 1 */}
            <div className="rounded-2xl border bg-white shadow-sm p-5">
              <h3 className="font-semibold">Stakeholder 1 *</h3>
              <input name="stackeHolder1" type="file" accept="image/*" required className="mt-3" />
              <input name="stack1Title" type="text" placeholder="Enter Title" required className="mt-3 w-full rounded-lg border px-3 py-2.5 text-sm" />
              <input name="stack1desc" type="text" placeholder="Enter Description" required className="mt-2 w-full rounded-lg border px-3 py-2.5 text-sm" />
            </div>

            {/* 2 */}
            <div className="rounded-2xl border bg-white shadow-sm p-5">
              <h3 className="font-semibold">Stakeholder 2 *</h3>
              <input name="stakeHolder2" type="file" accept="image/*" required className="mt-3" />
              <input name="stack2Title" type="text" placeholder="Enter Title" required className="mt-3 w-full rounded-lg border px-3 py-2.5 text-sm" />
              <input name="stack2desc" type="text" placeholder="Enter Description" required className="mt-2 w-full rounded-lg border px-3 py-2.5 text-sm" />
            </div>

            {/* 3 */}
            <div className="rounded-2xl border bg-white shadow-sm p-5">
              <h3 className="font-semibold">Stakeholder 3 *</h3>
              <input name="stakeHolder3" type="file" accept="image/*" required className="mt-3" />
              <input name="stack3Title" type="text" placeholder="Enter Title" required className="mt-3 w-full rounded-lg border px-3 py-2.5 text-sm" />
              <input name="stack3desc" type="text" placeholder="Enter Description" required className="mt-2 w-full rounded-lg border px-3 py-2.5 text-sm" />
            </div>

            {/* 4 (optional) */}
            <div className="rounded-2xl border bg-white shadow-sm p-5">
              <h3 className="font-semibold">Stakeholder 4</h3>
              <input name="stakeHolder4" type="file" accept="image/*" className="mt-3" />
            </div>
          </section>

          <div className="flex items-center justify-end gap-3 pt-2">
            <button type="reset" className="rounded-xl border px-5 py-2.5">Cancel</button>
            <button type="submit" className="rounded-xl bg-[#536878] px-5 py-2.5 text-white">Save Project</button>
          </div>
        </form>
      </main>
    </div>
